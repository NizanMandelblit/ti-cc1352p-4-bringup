...
#define CONFIG_CC1352P_4_LAUNCHXL
...
extern const uint_least8_t              CONFIG_NVS0_CONST;
#define CONFIG_NVS0                     0
extern const uint_least8_t              CONFIG_NVS_RAM_CONST;
#define CONFIG_NVS_RAM                  1
